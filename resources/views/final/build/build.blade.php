...
<head>
	...
	<link rel="stylesheet" href="css\homeBuild.css">
...
<body id="body">
	...
	<div id="all" style="position:<?php echo (old('logIn')=='true' || old('register')=='true')?"fixed":"unset" ?>;overflow:<?php echo (old('logIn')=='true' || old('register')=='true')?"hidden":"auto" ?>;">
		...
		<div class="main">
      <h2 class="generic_h2"><div>Start your build!</div></h2>
      @if(!Auth::check())
        <p class="attention"><strong>Attention!</strong> You are not logged in. Your build will not be saved.</p>
      @endif
    </div>
    ...
    <div>
      ...
      <ul>
				<li><strong>Please read carefully each step of the process. The success of your build depends on the correct completion of every step.</strong></li>
        <li>If you can't find a software you are looking for, please let us know and will add it as soon a we can.</li>
        <li>If you don't want to/can't wait to start building, you'll be able to manually add any software later in the process.</li>
        <li>We are not responsible for any compatibility issues you may have in the future.</li>
      </ul>
    </div>
    <div>
      <a href="/build/step1" class="bar_li"> 
        <div class="bar_a"><div>Lets get started!</div></div>
      </a>
    </div>
	</div>
</body>
