...
<body id="body">
	...
	<div id="all" style="position:<?php echo (old('logIn')=='true' || old('register')=='true')?"fixed":"unset" ?>;overflow:<?php echo (old('logIn')=='true' || old('register')=='true')?"hidden":"auto" ?>;">
		...
		<div class="main">
      <h2 class="generic_h2"><div>Step one:</div></h2>
      <div class="info-icon">
      <h3>Choose your operating system of preference <i class="far fa-question-circle"></i></h3>
      <p class="info">An operating system (OS) is system software that manages computer hardware and software resources and provides common services for computer programs. If you still haven't made up your mind on which one you prefer, we suggest you spend some time looking into all of them. The OS will be an essential part of your experience.</p>
      </div>
    </div>
    ...
    <div>
        ...
        <section>
          <div>
            <input class="mega_input" type="radio" id="control_01" name="select" value="windows" checked>
            <label class="mega_label" for="control_01">
              <h2>Windows</h2>
            </label>
          </div>
          <div>
            <input class="mega_input" type="radio" id="control_02" name="select" value="macOS">
            <label class="mega_label" for="control_02">
              <h2>MacOS</h2>
            </label>
          </div>
          <div>
            <input class="mega_input" type="radio" id="control_03" name="select" value="linux">
            <label class="mega_label" for="control_03">
              <h2>Linux</h2>
            </label>
          </div>
        </section>
        <input type="submit" class="bar_li bar_a" value="Next step">
      </form>
    </div>
	</div>
</body>
